...
import com.evertonalves.cursomc.domain.ItemPedido;
...
import com.evertonalves.cursomc.repositories.ItemPedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "everton10alves@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "everton-alves25@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
